...
<section role="main" class="content-body">
    <header class="page-header">
        ...
        <div class="right-wrapper text-end">
            <ol class="custom-breadcrumbs breadcrumbs">
                ...
                <li><span>Создание формы</span></li>
            </ol>
        </div>
    </header>
    ...
    <section class="card">
        <header class="card-header">
            <h2 class="card-title">Создание формы</h2>
        </header>
        <div class="card-body">
            <form class="form-horizontal form-bordered" method="POST" action="{{ route('admin.feedback.forms.store') }}">
                @csrf
