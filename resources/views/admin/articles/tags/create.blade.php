...
<section role="main" class="content-body">
    ...
    <section class="card">
        <header class="card-header">
            <h2 class="card-title">Создание тега</h2>
        </header>
        <div class="card-body">
            <form class="form-horizontal form-bordered" method="POST" action="{{ route('admin.articles.tags.store') }}" enctype="multipart/form-data">
                @csrf
